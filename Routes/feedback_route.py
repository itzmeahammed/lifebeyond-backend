...
feedback_bp.add_url_rule('/getAllFeedback', view_func=FeedbackController.getAllFeedBack, methods=['POST'])
feedback_bp.add_url_rule('/getFeedbackByUser', view_func=FeedbackController.getFeedbackByUser, methods=['POST'])
